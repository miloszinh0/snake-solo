...
class Snake:
    ...
    def restart(self):
        ...
        self.board[round(self.board_size/4)][round(self.board_size/4)] = self.head
        self.board[round(self.board_size/4)-1][round(self.board_size/4)] = 2
        self.board[round(self.board_size/2)][round(self.board_size/2)] = self.apple

        self.head_pos = [round(self.board_size/4), round(self.board_size/4)]
        self.apple_pos = [round(self.board_size/2), round(self.board_size/2)]
